...
export class ConstituencyControllerBase {
  constructor(
  ...
  @common.Post()
  @swagger.ApiCreatedResponse({ type: Constituency })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: ConstituencyCreateInput
  ...
  @common.Get()
  @swagger.ApiOkResponse({ type: [Constituency] })
  @swagger.ApiForbiddenResponse()
  @ApiNestedQuery(ConstituencyFindManyArgs)
  async findMany(@common.Req() request: Request): Promise<Constituency[]> {
    const args = plainToClass(ConstituencyFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: ConstituencyWhereUniqueInput
  ...
  async update(
    @common.Param() params: ConstituencyWhereUniqueInput,
    @common.Body() data: ConstituencyUpdateInput
  ): Promise<Constituency | null> {
    try {
